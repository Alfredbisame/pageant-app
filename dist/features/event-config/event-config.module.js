...
const public_event_controller_1 = require("./public-event.controller");
...
exports.EventConfigModule = EventConfigModule = __decorate([
    (0, common_1.Module)({
        controllers: [event_config_controller_1.EventConfigController, public_event_controller_1.PublicEventController],
