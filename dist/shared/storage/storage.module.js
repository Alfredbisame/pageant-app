    ...
    (0, common_1.Module)({
        providers: [
            ...
            cloudinary_storage_service_1.CloudinaryStorageService,
            {
                ...
                inject: [config_1.ConfigService, local_storage_service_1.LocalStorageService, cloudinary_storage_service_1.CloudinaryStorageService],
                useFactory: (config, localStorage, cloudinaryStorage) => {
                    const driver = config.get('storage.driver', 'local');
                    return driver === 'cloudinary' ? cloudinaryStorage : localStorage;
                },
            },
        ],
        exports: [storage_interface_1.STORAGE_SERVICE, local_storage_service_1.LocalStorageService, cloudinary_storage_service_1.CloudinaryStorageService],
    })
], StorageModule);
